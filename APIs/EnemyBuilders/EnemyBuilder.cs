...
namespace ItemAPI
{
    public static class EnemyBuilder
    {
        ...
        public static void SetupEntry(this AIActor enemy, string shortDesc, string longDesc, string portrait, string AmmonomiconSprite, string EnemyName)
        {
            ...
            ReloadModule.Strings.Enemies.Set("#" + EnemyName.ToUpper(), EnemyName);
            ReloadModule.Strings.Enemies.Set("#" + shortDesc.ToUpper(), shortDesc);
            ReloadModule.Strings.Enemies.Set("#" + longDesc.ToUpper(), longDesc);
