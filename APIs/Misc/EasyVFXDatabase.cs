...
namespace Reload
{
    public class EasyVFXDatabase
    {
        ...
        public static GameObject ItemPoofVFX = ResourceCache.Acquire("Global VFX/VFX_Item_Spawn_Poof") as GameObject;
       ...
       public static GameObject VFXElectroLink = PickupObjectDatabase.GetById(298).GetComponent<ComplexProjectileModifier>().ChainLightningVFX;
